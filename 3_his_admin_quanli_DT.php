                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Triệu chứng</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->pres_pat_age;?> Năm</td>
                                                    <td><?php echo $row->pres_pat_type;?></td>
                                                    <td>
                                                        <a href="3_his_admin_danhsach_DT.php?pres_number=<?php echo $row->pres_number;?>" class="badge badge-success"><i class="fas fa-eye"></i> Hiển thị</a>
                                                        <a href="3_his_admin_capnhat_DT.php?pres_number=<?php echo $row->pres_number;?>" class="badge badge-warning"><i class="fas fa-eye-dropper "></i> Sửa</a>
                                                        <a href="3_his_admin_quanli_DT.php?delete_pres_number=<?php echo $row->pres_number;?>" class="badge badge-danger"><i class=" fas fa-trash-alt "></i> Xóa</a>
