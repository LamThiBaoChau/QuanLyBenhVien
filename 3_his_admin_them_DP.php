                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Thêm dược phẩm</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"> Thông tin dược phẩm</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Tên dược phẩm</label>
                                                    <input type="text" required="required" name="phar_name" class="form-control" id="inputEmail4" >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Số lượng dược phẩm (Thùng)</label>
                                                    <input required="required" type="text" name="phar_qty" class="form-control"  id="inputPassword4">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Loại dược phẩm</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Người bán dược phẩm</label>
                                            ...
                                            <div class="form-group">
                                                    <label for="inputPassword4" class="col-form-label">Mã vạch dược phẩm(EAN-8)</label>
                                                    <?php 
                                                        $length = 10;    
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Mô tả dươc phẩm</label>
                                                <textarea required="required" type="text" class="form-control" name="phar_desc" id="editor"></textarea>
                                            </div>

                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Thêm dược phẩm</button>
