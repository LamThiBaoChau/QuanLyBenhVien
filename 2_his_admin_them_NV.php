                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Mã bác sĩ</label>
                                            ...
                                            <button type="submit" name="add_doc" class="ladda-button btn btn-success" data-style="expand-right">Thêm</button>
