                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Quản lý dược phẩm</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Quản lý dược phẩm </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            <div class="col-12 text-sm-center form-inline" >
                                                <div class="form-group mr-2" style="display:none">
                                                    <select id="demo-foo-filter-status" class="custom-select custom-select-sm">
                                                        ...
                                                        <option value="InPatients">Nhập viện</option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Người bán</th>
                                                <th data-hide="phone">Loại</th>
                                                <th data-hide="phone">Số lượng</th>
                                                <th data-hide="phone">Chức năng</th>
                                            </tr>
                                            </thead>
                                            <?php
                                            /*
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="3_his_admin_xem_DP.php?phar_bcode=<?php echo $row->phar_bcode;?>" class="badge badge-success"><i class="far fa-eye "></i> Hiển thị</a>
                                                        <a href="3_his_admin_capnhat_DP.php?phar_bcode=<?php echo $row->phar_bcode;?>" class="badge badge-warning"><i class="fas fa-clipboard-check "></i> Sửa</a>
                                                        <a href="his_admin_quanli_DP.php?delete_pharm_name=<?php echo $row->phar_id;?>" class="badge badge-danger"><i class="fas fa-trash-alt"></i> Xóa</a>
