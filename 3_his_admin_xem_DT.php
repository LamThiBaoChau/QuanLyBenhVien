                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Tên : <?php echo $row->pres_pat_name;?></h2>
                                                    <hr>
                                                    <h3 class="text-danger">Tuổi : <?php echo $row->pres_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Mã bệnh nhân : <?php echo $row->pres_pat_number;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Loại bệnh nhân : <?php echo $row->pres_pat_type;?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Triệu chứng bệnh nhân : <?php echo $row->pres_pat_ailment;?></h3>
                                                    <hr>
                                                    <h2 class="align-centre">Đơn thuốc</h2>
                                                    <hr>
