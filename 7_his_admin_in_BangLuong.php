                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="float-right">
                                                <h4 class="m-0 d-print-none"><?php echo $row->pay_doc_name;?> Lương</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    <p class="m-b-10"><strong>Ngày tạo : </strong> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo date("d-m-Y - h:m:s", strtotime($mysqlDateTime));?> </span></p>
                                                    <p class="m-b-10"><strong>Trạng thái : </strong> <span class="float-right"><span class="badge badge-success"><?php echo $row->pay_status;?></span></span></p>
                                                    <p class="m-b-10"><strong>Mã lương. : </strong> <span class="float-right"><?php echo $row->pay_number;?></span></p>
                                                    <p class="m-b-10"><strong>Mã nhân viên. : </strong> <span class="float-right"><?php echo $row->pay_doc_number;?></span></p>
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive">
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        <thead>
                                                        <tr><th>#</th>
                                                            <th>Phòng ban nhân viên</th>
                                                            <th style="width: 10%">Lương</th>
                                                            <th style="width: 10%">Thuế</th>
                                                            <th style="width: 10%" class="text-right">Tổng lương</th>
                                                        </tr></thead>
                                                        <tbody>
                                                        <tr>
                                                            <td><?php echo $cnt;?></td>
